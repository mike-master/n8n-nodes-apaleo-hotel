...
export const reservationActionProperties: INodeProperties[] = [
		...
		options: [
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/assign-unit Assign unit to reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/assign-unit/{unitId} Assign specific unit to reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/unassign-unit Unassign unit from reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/checkin Check in a reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/checkout Check out a reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/noshow Mark a reservation as no-show',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/amend/$force Amend a reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/book-service/$force Book a service for a reservation',
			...
			},
			{
				...
				description:
					'Endpoint: /booking/v1/reservation-actions/{id}/add-city-tax Add city tax to a reservation',
	...
	},
	{
		...
		options: [
			{
				name: 'Allow Overbooking',
				value: 'allowOverbooking',
			},
			{
				name: 'Allow Unit Type Change',
				value: 'allowUnitTypeChange',
			},
		],
		default: [],
	...
	},
	{
		...
		default: '',
		description:
			"The start date and optional time for the unit assignment. If not specified, the reservation's arrival will be used. Specify either a pure date or a date and time (without fractional second part) in UTC or with UTC offset as defined in ISO8601:2004",
		displayOptions: {
			show: {
				resource: ['reservationAction'],
				operation: ['PUT assign specific unit to reservation'],
	...
	},
	{
		...
		default: '',
		description:
			"The end date and optional time for the unit assignment. If not specified, the reservation's departure will be used. Specify either a pure date or a date and time (without fractional second part) in UTC or with UTC offset as defined in ISO8601:2004",
		displayOptions: {
			show: {
				resource: ['reservationAction'],
				operation: ['PUT assign specific unit to reservation'],
